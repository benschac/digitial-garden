...
summary: "A quick debugging session on how fixing the error \"The package at \"../../node_modules/next/dist/compiled/gzip-size/index.js\" attempted to import the Node standard library module \"fs\"."
